...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        .storyline-wrapper:hover .hidden{
...
movie_tile_content = '''
<div class="col-xs-12  col-sm-6 col-md-6  col-lg-4 movie-tile text-center storyline-wrapper" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    <div class="storyline">
        <div class="hidden">{storyline}</div>
    </div>
